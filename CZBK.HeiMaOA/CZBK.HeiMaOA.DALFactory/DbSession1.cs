	...
	public partial class DBSession : IDBSession
    {
        ...
        public IBooksDal BooksDal
        {
            get
            {
                if(_BooksDal == null)
                {
                    _BooksDal = DALAbstractFactory.CreateBooksDal();
                }
                return _BooksDal;
            }
            set { _BooksDal = value; }
        ...
        public IFileInfoDal FileInfoDal
        {
            get
            {
                ...
                {
                    _FileInfoDal = DALAbstractFactory.CreateFileInfoDal();
                }
                return _FileInfoDal;
            }
        ...
        public ISearchDetailsDal SearchDetailsDal
        {
            get
            {
                ...
                {
                    _SearchDetailsDal = DALAbstractFactory.CreateSearchDetailsDal();
                }
